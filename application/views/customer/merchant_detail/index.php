						...
						<div class="content-tabs-auth-detail relative content-tab-auth-1 border active-tabs-auth-detail top-padding-15-default bottom-padding-15-default left-padding-default right-padding-default discussions">
							<div class="row">
								<div class="col-sm-12 col-md-12">
									<img class="img img-responsive merchant-header hidden-md hidden-lg" src="<?= base_url() ?>public/img/profile_toko/<?= $toko->gambar ? $toko->gambar : "merchant.png" ?>" alt="">
									...
									<div class="col-sm-12 text-center top-margin-15-default">
