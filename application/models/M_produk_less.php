...
class M_produk_less extends CI_Model
{
    ...
    var $table         = 'produk';
    var $column_order  = array('toko_id', 'nama', 'harga_asli', 'harga_disc', 'terjual', 'rating', 'ban');
    var $column_search = array('nama_toko', 'nama', 'harga_asli', 'harga_disc', 'terjual', 'rating', 'ban');
